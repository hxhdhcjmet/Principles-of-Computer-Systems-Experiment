...
\begin{lstlisting}[title={openhitls/testcode/demo/sm4\_xbox.c}]
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 1\textwidth]{figure/sm4_xbox.png}
    \caption{SM4默认XBox}
\end{figure}
...
\]
关键代码如下:
\begin{lstlisting}[title={openhitls/testcode/demo/sm4\_xbox\_merged.c}]
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 1\textwidth]{figure/sm4_xbox_merge.png}
    \caption{SM4XBox合并}
\end{figure}
